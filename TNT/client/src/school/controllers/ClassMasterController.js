...
(function( define ) {
    ...
    /**
     * Register the ClassMasterController class with RequireJS
     */
    define( [ 'utils/supplant', 'utils/constants', 'utils/app'], function ( supplant, constants,app )
    {
             ...
             * @constructor
             */
    	var ClassMasterController = function($scope, $q, $location, $rootScope, $log, $route, $http )
    	{

    		$log.info("ClassMasterController.... ");
        ...
        return [ "$scope", "$q", "$location","$rootScope","$log","$route","$http", ClassMasterController ];
